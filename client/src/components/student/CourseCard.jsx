  ...
  return (
    ...
    className='border border-gray-500/30 pb-6 overflow-hidden rounded-lg'>
       ...
       <div className='p-3 text-left'>
        ...
        <p className='text-gray-500'>Smiruthi_LMS</p>
        ...
        <p className='text-base font-semibold text-gray-800'>{currency}{(course.coursePrice - course.discount *
           course.coursePrice / 100).toFixed(2)}</p>
       </div>
    </Link>
  )
}
